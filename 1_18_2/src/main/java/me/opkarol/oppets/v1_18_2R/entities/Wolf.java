...
public class Wolf extends AgeableEntity {
    public Wolf(@NotNull Player player) {
        super(EntityType.WOLF, (((CraftWorld) player.getWorld())).getHandle());
    }
