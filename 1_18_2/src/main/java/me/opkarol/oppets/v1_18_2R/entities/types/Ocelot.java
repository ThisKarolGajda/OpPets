...
public class Ocelot extends AgeableEntity {
    public Ocelot(@NotNull Player player) {
        super(EntityType.OCELOT, (((CraftWorld) player.getWorld())).getHandle());
    }

    @Override
    public TypeOfEntity getTypeOfEntity() {
        return TypeOfEntity.OCELOT;
    }
}
