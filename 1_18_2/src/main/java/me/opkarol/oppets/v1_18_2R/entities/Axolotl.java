...
public class Axolotl extends AgeableEntity {
    public Axolotl(@NotNull Player player) {
        super(EntityType.AXOLOTL, (((CraftWorld) player.getWorld())).getHandle());
    }
