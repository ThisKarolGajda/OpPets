...
public class Fox extends AgeableEntity {
    public Fox(@NotNull Player player) {
        super(EntityType.FOX, (((CraftWorld) player.getWorld())).getHandle());
    }

    @Override
    public TypeOfEntity getTypeOfEntity() {
        return TypeOfEntity.FOX;
    }
}
