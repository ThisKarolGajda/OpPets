...
public class Cow extends AgeableEntity {
    public Cow(@NotNull Player player) {
        super(EntityType.COW, (((CraftWorld) player.getWorld())).getHandle());
    }

    @Override
    public TypeOfEntity getTypeOfEntity() {
        return TypeOfEntity.COW;
    }
}
