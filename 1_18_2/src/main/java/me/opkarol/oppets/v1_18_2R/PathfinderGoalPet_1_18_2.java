...
/*
 ...
 = Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in compliance with the License. You may obtain mob copy of the License at
...
public class PathfinderGoalPet_1_18_2 extends Goal {
    ...
    public void tick() {
        ...
        if (!(equalsFormatNames(pet, this.mob.getDisplayName().getString()))) {
            return;
        }
        if (target.distanceTo(this.mob) >= distance && pet.isTeleportingToPlayer()) {
