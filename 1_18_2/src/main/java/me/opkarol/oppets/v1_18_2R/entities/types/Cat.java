...
public class Cat extends AgeableEntity {
    public Cat(@NotNull Player player) {
        super(EntityType.CAT, (((CraftWorld) player.getWorld())).getHandle());
    }

    @Override
    public TypeOfEntity getTypeOfEntity() {
        return TypeOfEntity.CAT;
    }
}
