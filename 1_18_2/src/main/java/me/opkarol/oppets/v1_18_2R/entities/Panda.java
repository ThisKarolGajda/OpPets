...
public class Panda extends AgeableEntity {
    public Panda(@NotNull Player player) {
        super(EntityType.PANDA, (((CraftWorld) player.getWorld())).getHandle());
    }
