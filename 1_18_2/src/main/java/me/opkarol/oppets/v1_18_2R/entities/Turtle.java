...
public class Turtle extends AgeableEntity {
    public Turtle(@NotNull Player player) {
        super(EntityType.TURTLE, (((CraftWorld) player.getWorld())).getHandle());
    }
