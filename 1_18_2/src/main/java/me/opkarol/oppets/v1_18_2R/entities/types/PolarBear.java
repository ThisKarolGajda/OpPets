...
public class PolarBear extends AgeableEntity {
    public PolarBear(@NotNull Player player) {
        super(EntityType.POLAR_BEAR, (((CraftWorld) player.getWorld())).getHandle());
    }

    @Override
    public TypeOfEntity getTypeOfEntity() {
        return TypeOfEntity.POLAR_BEAR;
    }
}
