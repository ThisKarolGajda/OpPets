...
public class Llama extends AgeableEntity {
    public Llama(@NotNull Player player) {
        super(EntityType.LLAMA, (((CraftWorld) player.getWorld())).getHandle());
    }
