...
public class Chicken extends AgeableEntity {
    public Chicken(@NotNull Player player) {
        super(EntityType.CHICKEN, ((CraftWorld) player.getWorld()).getHandle());
    }

    @Override
    public TypeOfEntity getTypeOfEntity() {
        return TypeOfEntity.CHICKEN;
    }
}
