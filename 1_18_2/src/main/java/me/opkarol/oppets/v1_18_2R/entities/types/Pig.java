...
public class Pig extends AgeableEntity {
    public Pig(@NotNull Player player) {
        super(EntityType.PIG, (((CraftWorld) player.getWorld())).getHandle());
    }

    @Override
    public TypeOfEntity getTypeOfEntity() {
        return TypeOfEntity.PIG;
    }
}
