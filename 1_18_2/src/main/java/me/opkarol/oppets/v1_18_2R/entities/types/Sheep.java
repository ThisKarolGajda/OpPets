...
public class Sheep extends AgeableEntity {
    public Sheep(@NotNull Player player) {
        super(EntityType.SHEEP, (((CraftWorld) player.getWorld())).getHandle());
    }

    @Override
    public TypeOfEntity getTypeOfEntity() {
        return TypeOfEntity.SHEEP;
    }
}
