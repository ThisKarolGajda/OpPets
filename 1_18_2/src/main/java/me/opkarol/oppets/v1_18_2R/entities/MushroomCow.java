...
public class MushroomCow extends AgeableEntity {
    public MushroomCow(@NotNull Player player) {
        super(EntityType.MOOSHROOM, (((CraftWorld) player.getWorld())).getHandle());
    }
    ...
    public TypeOfEntity getTypeOfEntity() {
        return TypeOfEntity.MUSHROOM_COW;
    }
