...
public class Rabbit extends AgeableEntity {
    public Rabbit(@NotNull Player player) {
        super(EntityType.RABBIT, (((CraftWorld) player.getWorld())).getHandle());
    }

    @Override
    public TypeOfEntity getTypeOfEntity() {
        return TypeOfEntity.RABBIT;
    }
}
