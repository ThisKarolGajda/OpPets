...
public class Horse extends AgeableEntity {
    public Horse(@NotNull Player player) {
        super(EntityType.HORSE, (((CraftWorld) player.getWorld())).getHandle());
    }

    @Override
    public TypeOfEntity getTypeOfEntity() {
        return TypeOfEntity.HORSE;
    }
}
