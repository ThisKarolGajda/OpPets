package me.opkarol.oppets.api.items.builder;
...
import static me.opkarol.oppets.utils.external.FormatUtils.formatList;
import static me.opkarol.oppets.utils.external.FormatUtils.formatMessage;
...
public class OpItemBuilder {
    ...
    public ItemStack addAndGetPdc(NamespacedKey key, String value) {
        ItemStack itemStack = getItem();
        PDCUtils.addNBT(itemStack, key, value);
        return itemStack;
    }

    @Contract(" -> new")
    public static @NotNull OpItemBuilder getBuilder() {
        return new OpItemBuilder();
    }
    ...
    public OpItemBuilder setPath(@NotNull String path) {
