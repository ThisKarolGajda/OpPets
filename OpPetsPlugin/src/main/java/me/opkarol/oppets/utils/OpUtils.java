...
public class OpUtils {
    ...
    public static int getMaxLevel(@NotNull Pet pet) {
        return OpPets.getSkillDatabase().getSkillFromMap(pet.getSkillName()).getH();
    }
     ...
     * @see me.opkarol.oppets.utils.OpUtils#getAdderPoints
     */
     ...
     * @param  pet          class object from which object will be read
     * @return adderPoints  double object that is a value
     */
