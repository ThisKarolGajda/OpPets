...
import me.opkarol.oppets.cache.LeaderboardCache;
import me.opkarol.oppets.inventories.LeaderboardInventory;
...
public class LeaderboardCounter {
    ...
    private void updateTick() {
        ...
        }.runTaskTimerAsynchronously(OpPets.getInstance(), 20 * 60, 20 * 60);
    }
    ...
    private void updateLeaderboards() {
        new BukkitRunnable() {
            @Override
            public void run() {
                HashMap<UUID, Pet> pets = OpPets.getDatabase().getActivePetMap();
